...
LD_PRELOAD=./hypertrash_crash_detector sudo /home/user/qemu-5.2.0/build/qemu-system-x86_64 -cdrom hypertrash.iso -enable-kvm -m 100 -net none -nographic -device e1000e,netdev=net0 -netdev tap,id=net0,ifname=tap0,script=no,downscript=no
