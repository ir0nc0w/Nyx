...
LD_PRELOAD=./hypertrash_crash_detector sudo /home/user/qemu-5.2.0/build/qemu-system-x86_64 -cdrom hypertrash.iso -enable-kvm -m 100 -net none -device am53c974,id=scsi -device scsi-hd,drive=SysDisk -drive id=SysDisk,if=none,file=hdd.img 
